...
cell_style_dict = {
    ...
    "TPOX": TPOX,
    "vWA": vWA,
    "Mixed Sample": lambda x: {"style": "text-align:center"},
    "Shared Markers": lambda x: {"style": "text-align:center"},
    "Shared Alleles": lambda x: {"style": "text-align:center"},
    "Tanabe Score": lambda x: {"style": "text-align:center"},
    "Master Query Score": lambda x: {"style": "text-align:center"},
    "Master Ref Score": lambda x: {"style": "text-align:center"},
}
                ...
                ui.card(
                    ui.layout_sidebar(
                        ui.panel_sidebar(
                            ...
                            ui.card(
                                ui.input_switch(
                                    "score_amel_query", "Score Amelogenin", value=True
                                ),
                                ui.input_numeric(
                                    "mix_threshold_query",
                        ...
                        ui.panel_main(
                                ...
                                ui.column(
                                    ...
                                    ui.row(
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_1", "Amelogenin", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_2", "CSF1PO", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_3", "D2S1338", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_4", "D3S1358", placeholder=""
                                            ),
                                        ),
                                    ),
                                    ui.row(
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_5", "D5S818", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_6", "D7S820", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_7", "D8S1179", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_8", "D13S317", placeholder=""
                                            ),
                                        ),
                                    ),
                                    ui.row(
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_9", "D16S539", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_10", "D18S51", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_11", "D19S433", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_12", "D21S11", placeholder=""
                                            ),
                                        ),
                                    ),
                                    ui.row(
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_13", "FGA", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_14", "Penta D", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_15", "Penta E", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_16", "TH01", placeholder=""
                                            ),
                                        ),
                                    ),
                                    ui.row(
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_17", "TPOX", placeholder=""
                                            ),
                                        ),
                                        ui.column(
                                            3,
                                            ui.input_text(
                                                "marker_18", "vWA", placeholder=""
                                            ),
                                        ),
                            ...
                            ui.tags.hr(),
                            ui.input_action_button(
                                "search", "Search", class_="btn-success"
                            ),
                            ui.input_action_button(
                                "reset", "Reset Inputs / Results", class_="btn-danger"
                            ),
                        ),
                    ),
                ),
                ...
                ui.card(
                    ui.layout_sidebar(
                        ui.panel_sidebar(
                            ...
                            ui.card(
                                ui.input_checkbox(
                                    "score_amel_batch", "Score Amelogenin", value=True
                                ),
                                ui.input_numeric(
                                    "mix_threshold_batch",
                                    "'Mixed' Sample Threshold",
            ...
            ui.card(
                ui.layout_sidebar(
                    ui.panel_sidebar(
                        ...
                        ui.card(
                            ui.input_checkbox(
                                "score_amel_file", "Score Amelogenin", value=True
                            ),
                            ui.input_numeric(
                                "mix_threshold_file",
                                "'Mixed' Sample Threshold",
